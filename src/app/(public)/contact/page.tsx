      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <section aria-labelledby="map-heading">
            ...
            {/* Google Map Embed — corrected iframe */}
            <div className="border border-gray-200 rounded overflow-hidden">
              <iframe
                title="বেফাকুল মাদারিসিল আরাবিয়া বাংলাদেশ অফিসের অবস্থান"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3072.7159272386016!2d90.44367177452732!3d23.711261078697135!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b9d4656da187%3A0x323bd61360273d9d!2sWifaqul%20Madarishil%20Arabia%20Bangladesh!5e1!3m2!1sen!2sus!4v1773818350754!5m2!1sen!2sus"
                width="100%"
                height="320"
